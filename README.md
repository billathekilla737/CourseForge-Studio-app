...
|---|---|---|---|
| **CourseForge PDF Fixer** | A Windows desktop app that backs up, repairs and re-uploads a course's PDFs, and proves the result against PDF/UA-1 | An instructor, on their own PC, with no Python and no PowerShell | **v1.1.9 — security hardened** |
