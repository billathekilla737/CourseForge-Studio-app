> **This file is one worked example, not a universal rule.** It documents a real
> navy-and-gold component library built for one school (MGCCC). Copy this file,
> replace the hex values and component names with your own institution's brand, and
> keep the *structure*: a hero, section cards, an info/alert box pattern, a footer,
> and the hard accessibility + Canvas-sanitizer rules below (those ARE universal -
